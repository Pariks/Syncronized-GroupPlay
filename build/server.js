...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.USE_WEBPACK === "true") {
		...
		console.log(_chalk2.default.bgRed("Using webpack Dev Middleware! THIS IS DEV ONLY"));
	}
	...
	var useExtenalStyles = !isDevelopment;
	
	app.get("/", function (req, res) {
		res.render("index", {
			useExtenalStyles: useExtenalStyles
		});
	});
	...
	function createConfig(isDebug) {
	  ...
	  sassLoader.loader = ExtractTextPlugin.extract("style", "css!sass");*/
		...
		return {
			...
			module: {
				loaders: [{ test: /\.js$/, loader: "babel", exclude: /node_module/ }, { test: /\.js$/, loader: "eslint", exclude: /node_module/ }, { test: /\.(png|jpg|jpeg|gif|ttf|eot|svg|woff2)/, loader: "url-loader?limit=512" }, cssLoader, sassLoader]
			},
			plugins: plugins
